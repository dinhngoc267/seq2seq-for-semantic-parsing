...
from copynet.dataset import CopyNetParserDataset
...
if __name__ == "__main__":
    train_dataset = CopyNetParserDataset(data_path="data/augmented_data.csv",
                                         device=device,
    ...
    val_dataset = CopyNetParserDataset(data_path="data/val_data.csv",
                                       device=device,
    ...
    checkpoint = ModelCheckpoint(dirpath="ckpts",
                                 save_top_k=1,
